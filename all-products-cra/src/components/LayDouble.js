...
class LayDouble extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            products: props
    ...
    render(){
        return (<div className="recent-work-wrapper">
                    ...
                    <div id="w-node-d430a835-63f5-0995-8ed8-4fdebfb748a2-97fd79fb" className="rare-work-left">
                        ...
                        <div className="recent_work_new">New</div>
                    ...
                    <div id="w-node-_2a2b7829-7cb7-215e-0883-8b24995eb0d7-97fd79fb" className="rare-work-right">
